...
<head>
    ...
    <title>{% block title %}BookTracker | Dashboard{% endblock %}</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="container-fluid px-4">
            ...
            <div class="d-flex align-items-center ms-auto">
                ...
                <div class="me-4 d-none d-md-block">
                    ...
                    <span class="fw-bold ms-1">{{ account_owner|default:request.user.get_full_name|default:request.user.username }}</span>
                </div>
                ...
                <div class="dropdown me-4">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end p-3" style="width: 300px;">
                        ...
                        <li><a class="dropdown-item" href="#"><i
                                    class="bi bi-exclamation-triangle text-warning me-2"></i>Low stock: The Great
                                Gatsby</a></li>
                        <li><a class="dropdown-item" href="#"><i class="bi bi-clock text-info me-2"></i>5 rentals due
                                tomorrow</a></li>
                        <li><a class="dropdown-item" href="#"><i class="bi bi-cart-check text-success me-2"></i>New
                                order received</a></li>
                        <li>
                ...
                <div class="dropdown">
                    <a href="#" class="d-flex align-items-center text-dark text-decoration-none dropdown-toggle"
                        ...
                        <img src="https://ui-avatars.com/api/?name={{ account_owner|default:request.user.username|urlencode }}&background=4361ee&color=fff&size=128"
                            alt="User" class="nav-user-img me-2">
                        <span class="d-none d-md-inline">{{ account_owner|default:request.user.username }}</span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="{% url 'profile_store_owner' %}"><i class="bi bi-person me-2"></i>Profile</a></li>
...
<div id="sidebar">
    ...
    <a href="{% url 'store_dashboard' %}" class="sidebar-item active">
        <i class="bi bi-speedometer2"></i> <span>Dashboard</span>
    </a>
    
    <!-- ORDER MANAGEMENT - Add this prominently -->
    <a href="{% url 'store_orders' %}" class="sidebar-item">
        <i class="bi bi-receipt"></i> <span>Order Management</span>
        {% if pending_orders_count %}
        <span class="badge bg-danger ms-auto">{{ pending_orders_count }}</span>
        {% endif %}
    </a>
    
    <a href="{% url 'store_wishlist' %}" class="sidebar-item">
        <i class="bi bi-heart"></i> <span>Wishlisted Books</span>
        <span class="badge bg-warning ms-auto">{{ wishlist_count|default:"0" }}</span>
    </a>

    <div class="sidebar-heading">Messages Management</div>
    <!-- In store/dashboard.html, add this to your sidebar navigation -->
<li class="nav-item">
    <a class=" sidebar-item active nav-link {% if request.resolver_match.url_name == 'store_chat_list' %}active{% endif %}" 
       href="{% url 'store_chat_list' %}">
        <i class="bi bi-chat-dots me-2"></i>
        Messages
        {% if total_unread %}
        <span class="badge bg-danger ms-auto">{{ total_unread }}</span>
        {% endif %}
    </a>
</li>

    <div class="sidebar-heading">Store Management</div>
    <a href="{% url 'store_registration' %}" class="sidebar-item">
        <i class="bi bi-cart"></i> <span>Register Store</span>
    </a>
    <a href="{% url 'store_registration_view' %}" class="sidebar-item">
        <i class="bi bi-list"></i> <span>View Stores</span>
    </a>
    
    <div class="sidebar-heading">Book Management</div>
    <a href="{% url 'add_book' %}" class="sidebar-item">
        <i class="bi bi-cart"></i> <span>Add Book</span>
    </a>
    <a href="{% url 'view_inventory' %}" class="sidebar-item">
        <i class="bi bi-people"></i> <span>View Inventory</span>
        <span class="badge bg-success ms-auto">{{ store_metrics.total_books|default:"0" }}</span>
    </a>
       <a href="{% url 'manage_books' %}" class="sidebar-item {% if request.resolver_match.url_name == 'manage_books' %}active{% endif %}">
                <i class="bi bi-pencil-square"></i>
                <span>Manage Books</span>
            </a>
    
             
            <a href="{% url 'logout' %}" class="sidebar-item logout-bottom">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <!-- Simple Generate Report button (stub for now) -->
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="h5 mb-0 fw-bold text-white">
                                    {{ account_owner|default:request.user.get_full_name|default:request.user.username }}
                                </div>
                            </div>
                    ...
                    <div class="store-stat-card pending h-100">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="h5 mb-0 fw-bold text-white">
                                    {{ pending_orders|default:store_metrics.pending_orders|default:"0" }}
                                </div>
                            </div>
                    ...
                    <div class="store-stat-card active h-100">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="h5 mb-0 fw-bold text-white">{{ active_orders|default:"0" }}</div>
                            </div>
                    ...
                    <div class="store-stat-card completed h-100">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="h5 mb-0 fw-bold text-white">{{ completed_orders|default:"0" }}</div>
                            </div>
                    ...
                    <div class="store-stat-card declined h-100">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="h5 mb-0 fw-bold text-white">{{ cancelled_orders|default:"0" }}</div>
                            </div>
                    ...
                    <div class="store-stat-card today h-100">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="h5 mb-0 fw-bold text-white">
                                    ${{ today_revenue|default:store_metrics.revenue_today|default:0|floatformat:2 }}
                                </div>
                            </div>
                    ...
                    <div class="store-stat-card month h-100">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="h5 mb-0 fw-bold text-white">
                                    ${{ month_revenue|default:store_metrics.revenue_month|default:0|floatformat:2 }}
                                </div>
                            </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <div class="dropdown no-arrow">
                                <a href="{% url 'store_orders' %}" class="btn btn-sm btn-primary">View All</a>
                            </div>
                        </div>
                        <div class="card-body">
                            {% if recent_orders %}
                                ...
                                <table class="table table-hover align-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-{% if order.status == 'pending' %}warning{% elif order.status == 'completed' %}success{% else %}secondary{% endif %}">
                                                    {{ order.status|title }}
                                                </span>
                                            </td>
                                        </tr>
    ...
    <script>
        ...
        const manageOrdersBtnMain = document.getElementById('manageOrdersBtnMain');
        if (manageOrdersBtnMain) {
            manageOrdersBtnMain.addEventListener('click', () => {
        ...
        if (viewReportsBtn) {
            viewReportsBtn.addEventListener('click', () => {
                showAlert('Reports', 'Loading sales reports dashboard...');
            });
        }
        ...
        if (customerListBtn) {
            customerListBtn.addEventListener('click', () => {
                showAlert('Customers', 'Opening customer database...');
            });
        }

        const addBookBtnSidebar = document.getElementById('addBookBtnSidebar');
        if (addBookBtnSidebar) {
            addBookBtnSidebar.addEventListener('click', () => {
                window.location.href = "{% url 'add_book_registration' %}";
            });
        }
        ...
        document.querySelectorAll('.order-actions button').forEach(button => {
            button.addEventListener('click', function (e) {
                ...
                const orderId = this.closest('.order-card').querySelector('.order-header strong').textContent.split(' - ')[0];
                showAlert('Order Action', `${action} for ${orderId}`);
            });
        });
        ...
        document.querySelectorAll('.alert-card button').forEach(button => {
            button.addEventListener('click', function (e) {
                e.stopPropagation();
                const action = this.textContent.trim();
                const alertType = this.closest('.alert-card').querySelector('h6').textContent;
                showAlert('Alert Action', `${action} for ${alertType}`);
            });
        });
        ...
        document.querySelectorAll('.header-nav-item').forEach(item => {
            item.addEventListener('click', function (e) {
                ...
                showAlert('Navigation', `Loading ${page} page...`);
            });
        });
        ...
        // Real-time updates simulation removed


        // Animate stats on load
        window.addEventListener('load', () => {
            const statElements = document.querySelectorAll('.store-stat-card .fs-6');
            statElements.forEach(element => {
                const text = element.textContent;
                if (text.includes('$')) {
                    animateValue(element, 0, parseInt(text.replace('$', '')), 1000);
                } else if (!isNaN(text)) {
                    animateValue(element, 0, parseInt(text), 1000);
                }
            });
        });
